...
\pgfsetlinewidth{1bp}
%%
\node (C) at (97.0bp,194.0bp) [draw,ellipse,argument] {\textbf{Main claim}\\We should all follow\\ a vegetarian life style.};
  \node (A1) at (97.0bp,119.0bp) [draw,ellipse,argument] {\textbf{Reason $R_1$}\\Most mass meat-farming techniques\\are torture to animals.};
  \node (A2) at (97.0bp,32.0bp) [draw,ellipse,argument] {\textbf{Reason $R_2$}\\Animals feel fear and pain\\like us. Mass meat-farming techniques\\ force animals living in them\\to have an unnaturally\\short, miserable and confined life.};
