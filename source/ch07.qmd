...
1. First, an author might express that **two statements are contradictory to each other**. For instance, the author might suggest that two statements are inconsistent, that is, they cannot both be true at the same time. In such cases, you can connect the two argumentative units with attack relations in both directions. 
