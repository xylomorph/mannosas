...
Now, we have formulated the additional reason $R^*$ that attacks $C$ and is supported by $R^1$. However, no text segment corresponds to this reason. Faithfulness to the text demands the use of reformulations that make it possible---and preferably easy---to identify the text segments that correspond to reasons.